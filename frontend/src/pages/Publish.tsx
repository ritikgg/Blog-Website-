        ...
        <div className="flex justify-center w-full pt-8">
            <div className="max-w-screen-lg w-full">
                <input onChange={(e) => {
                 ...
                 focus:ring-blue-500 focus:border-blue-500 block p-2.5" placeholder="Title" />
                ...
                }} type="submit" className="mt-4 inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white
